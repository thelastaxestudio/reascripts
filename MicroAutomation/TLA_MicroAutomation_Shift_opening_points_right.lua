-- @name TLA_MicroAutomation_Shift_opening_points_right
-- @about 
--   Bump opening points of a four-point selection to the right by 0.01 seconds.
...
function TLA.performAction()
  ...
  if envelopeProperties.armed and envelopeProperties.visible then
    ...
    TLA.setPointTime(envelope, firstPointOuter, firstPointOuter.time + TLA.config.increments)
    TLA.setPointTime(envelope, firstPointInner, firstPointInner.time + TLA.config.increments)
